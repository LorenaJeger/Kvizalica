...
public class KvizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference databaseReference = firebaseDatabase.getReference("Voce");

        // Here "image" is the child node value we are getting
        // child node data in the getImage variable
        DatabaseReference getImage = databaseReference.child("slika");
        ...
        getImage.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Toast.makeText(KvizActivity.this, "Error Loading Image", Toast.LENGTH_SHORT).show();
            }
        });
    }
